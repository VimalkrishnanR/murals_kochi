var config = {
    ...
    footer: 'A project developed during The Lede Program <br> Columbia University, Graduate School of Journalism<br><br> Methodology: Temple density in Ernakulam was calculated by querying the Google Places API using Python. Using QGIS, the distances between ASI protected monuments, the unlisted murals, and the state protected temple murals were calculated by running the distance to nearest hub (line to hub) vector analysis (projection: EPSG:32643 (WGS 84 / UTM Zone 43N). All The mural photographs (except the <i>Ramayana</i> hall mural) were taken by the author. For more details, see this GitHub repository:<a href="https://github.com/VimalkrishnanR/murals_kochi"> murals_kochi</a> <br><br> Acknowledegements: I thank all my instructors in the Lede program, especially Aaron Reiss, Youyou Zhou, and Veronica Penney, for their inputs on mapping, QGIS, D3 and Javascript which I have applied in this project. I also acknowledge Ana Muñoz Padrós and Ilena Peng for their mentorship sessions. I thank Jon Viktor Cabuenas for guidance on using Google Places API. I also thank my friends Gokul and Nandakumar.Finally, I thank Smitha, Ms. Smitha, ASI, Thrissur Circle, for her valuable inputs.<br><br> References:<br><br>1. Kerala Murals, Dr. M. Nambirajan, Dr. S Suresh, The Director General, Archaeological Survey of India (2015) <br>2. <i>Keralathile Chuvarchitrangal</i> Dr. M. G. Sasibhooshan, The State Institute of Languages, Kerala (2019) <br>3. R. Nandakumar, <a href="https://nandakumarr.blogspot.com/2022/05/a-little-jewel-box.html">A Little Jewel Box</a>, <i>Anamika</i>, Blogger(2022) <br>4.<a href="https://www.sahapedia.org/contextualizing-church-murals-of-kerala-within-the-mural-traditions-indian-churches"> The Mural Traditions in Indian Churches: Contextualising Church Murals of Kerala </a>,  Jenee Peter, Sahapedia <br><br>Created using <a href="https://github.com/mapbox/storytelling">Mapbox Storytelling</a> template. <br><br> <a href="https://commons.wikimedia.org/wiki/File:Mattancherry_Palace-16-17th_Century_mural_paintings-Scenes_from_the_Ramayana-WUS09250.jpg">Rainer Halama, Mattancherry Palace-16-17th Century mural paintings-Scenes from the Ramayana-WUS09250</a>, resized the image, added Interactivity, etc. by Vimal Krishnan R, <a href="https://creativecommons.org/licenses/by-sa/4.0/legalcode">CC BY-SA 4.0</a></span>', 
